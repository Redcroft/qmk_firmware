...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT_split_3x6_3_ex2(
				      KC_TAB,  KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,  KC_UP,       KC_BRIU, KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_QUOT,
				      KC_LCTL, KC_A,    KC_R,    KC_S,    KC_T,    KC_G,  KC_DOWN,     KC_BRID, KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_MNS,
  ...
  [_LOWER] = LAYOUT_split_3x6_3_ex2(
				    ...
				    _______, KC_MUTE, _______, _______, KC_ESC,  KC_LGUI,                       _______, _______, KC_LBRC, KC_RBRC, KC_HASH, KC_BSLS,
				    _______, _______, _______,          _______, _______, _______
				    ),
